...
@section('page-subtitle', 'Validez ou rejetez les demandes de boost')
...
<div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:1rem; margin-bottom:1.5rem;">
    <div style="display:flex; align-items:center; gap:0.75rem;">
        ...
        <div>
            ...
            <div style="font-size:0.8125rem; color:#64748b;">demande(s) en attente</div>
        </div>
    </div>
        ...
        <div style="display:flex; gap:1rem; align-items:flex-start;">
            ...
            <div style="flex:1; min-width:0;">
                <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:0.75rem; margin-bottom:0.5rem;">
                    ...
                    <span class="badge-status badge-status-pending" style="flex-shrink:0;">
                        <i class="fas fa-clock"></i>
                        En attente
                    </span>
                </div>
                ...
                <div style="display:flex; gap:0.625rem; flex-wrap:wrap; align-items:center;">
                    ...
                    {{-- Approuver --}}
                    <form method="POST" action="{{ route('boost.approve', $boost->id) }}"
                          onsubmit="return confirm('Approuver le boost #{{ $boost->id }} ?')">
                        @csrf
                ...
                <div x-show="rejectOpen" x-cloak style="margin-top:0.875rem;">
                    <form method="POST" action="{{ route('boost.reject', $boost->id) }}">
                        @csrf
